...
fetch('static/json/reference.json')
    ...
    .then(data => { 
        ...
        let delta = 0;
        let interval = 1 /30; //timer allows us to run at 45 fps
        ...
        function render() {
            ...
            if (delta > interval){
                ...
                if(wordList[wordidx] in data){
                var left = data[wordList[wordidx]][frameidx]['Left Hand Coordinates'];
                var right = data[wordList[wordidx]][frameidx]['Right Hand Coordinates'];
                }
                else{
                var letter_list = Array.from(wordList[wordidx]);
                wordList.splice(wordidx, 1);
                wordList.splice(wordidx, 0, ...letter_list);
                var left = data[wordList[wordidx]][frameidx]['Left Hand Coordinates'];
                var right = data[wordList[wordidx]][frameidx]['Right Hand Coordinates'];
                }
...
camera.position.set(27.5, -30, 40);
